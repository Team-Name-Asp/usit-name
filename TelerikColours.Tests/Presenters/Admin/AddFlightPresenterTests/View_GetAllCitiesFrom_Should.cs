...
{
    [TestFixture]
    public class View_GetAllCitiesFrom_Should
    {
        [TestCase(22)]
        [TestCase(1)]
        public void SetCityFromListOnVIewModelWithExpectedCollection_WhenGetAllCitiesFromEventIsRaised(int countryId)
        {
            // Arrange
            ...
            // Act
            viewStub.Raise(v => v.GetAllCitiesFrom += null, citiesCustomEventArgs);

            // Assert
            CollectionAssert.AreEquivalent(expectedCities, viewStub.Object.Model.CityFromList);
        }
    }
}
